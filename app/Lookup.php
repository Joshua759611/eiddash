...
class Lookup
{
    ...
    public static function cacher()
    {
        ...
        $iprophylaxis = DB::table('prophylaxis')->where(['ptype' => 2, 'flag' => 1])->where('rank_id', '>', 0)->orderBy('rank_id', 'asc')->get();
        $interventions = DB::table('prophylaxis')->where(['ptype' => 1, 'flag' => 1])->where('rank_id', '>', 0)->orderBy('rank_id', 'asc')->get();
